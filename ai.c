...
void Game1()
{
    ...
    else if(CSLeft_R>=226 && CSLeft_R<=246 && CSLeft_G>=131 && CSLeft_G<=151 && CSLeft_B<=20 && CSRight_R>=226 && CSRight_R<=246 && CSRight_G>=131 && CSRight_G<=151 && CSRight_B<=20&&(LoadedObjects>0))
    {
        Duration = 85;
        CurAction =1;
    }
    else if(CSLeft_R>=226 && CSLeft_R<=246 && CSLeft_G>=131 && CSLeft_G<=151 && CSLeft_B<=20&&(LoadedObjects>0
))
    {
        Duration = 0;
        CurAction =2;
    }
    else if(CSRight_R>=226 && CSRight_R<=246 && CSRight_G>=131 && CSRight_G<=151 && CSRight_B<=20&&(LoadedObjects>0
))
    {
        Duration = 0;
        CurAction =3;
    ...
    else if(PositionX>=1 && PositionX<=15)
    {
        Duration = 0;
        CurAction =6;
    }
    else if(PositionY>=1 && PositionY<=15)
    {
        Duration = 0;
        CurAction =7;
    }
    else if(PositionX>=63 && PositionX<=135 && PositionY>=134 && PositionY<=152 && Compass>=2 && Compass<=90&&(LoadedObjects>0))
    {
        Duration = 1;
        CurAction =8;
    }
    else if(PositionX>=63 && PositionX<=135 && PositionY>=134 && PositionY<=152 && Compass>=272&&(LoadedObjects>0
))
    {
        Duration = 1;
        CurAction =9;
    }
    else if(PositionX>=63 && PositionX<=135 && PositionY>=134 && PositionY<=152 && Compass>=92 && Compass<=270&&(LoadedObjects>0
))
    {
        Duration = 1;
        CurAction =10;
    }
    else if(PositionX>=265 && PositionX<=296 && PositionY>=134 && PositionY<=152 && Compass<=90&&(LoadedObjects>0))
    {
        Duration = 1;
        CurAction =11;
    }
    else if(PositionX>=265 && PositionX<=296 && PositionY>=134 && PositionY<=152 && Compass>=270&&(LoadedObjects>0))
    {
        Duration = 1;
        CurAction =12;
    }
    else if(PositionX>=265 && PositionX<=296 && PositionY>=134 && PositionY<=152 && Compass>=90 && Compass<=270&&(LoadedObjects>0))
    {
        Duration = 1;
        CurAction =13;
    }
    else if(PositionX>=119 && PositionX<=155 && PositionY>=76 && PositionY<=152 && Compass>=2 && Compass<=180&&(isin==1))
    {
        Duration = 0;
        CurAction =14;
    }
    else if(PositionX>=119 && PositionX<=155 && PositionY>=76 && PositionY<=152 && Compass>=182&&(isin==1))
    {
        Duration = 0;
        CurAction =15;
    }
    else if(PositionX>=74 && PositionX<=151 && PositionY>=134 && PositionY<=152 && Compass>=2 && Compass<=90&&(LoadedObjects<1))
    {
        Duration = 1;
        CurAction =16;
    }
    else if(PositionX>=74 && PositionX<=151 && PositionY>=134 && PositionY<=152 && Compass>=272&&(LoadedObjects<1
))
    {
        Duration = 1;
        CurAction =17;
    }
    else if(PositionX>=74 && PositionX<=151 && PositionY>=134 && PositionY<=152 && Compass>=92 && Compass<=270&&(LoadedObjects<1
))
    {
        Duration = 1;
        CurAction =18;
    }
    else if(PositionX>=198 && PositionX<=276 && PositionY>=134 && PositionY<=152 && Compass>=2 && Compass<=90&&(LoadedObjects<1
))
    {
        Duration = 1;
        CurAction =19;
    }
    else if(PositionX>=198 && PositionX<=276 && PositionY>=134 && PositionY<=152 && Compass>=272&&(LoadedObjects==0
))
    {
        Duration = 1;
        CurAction =20;
    }
    else if(PositionX>=265 && PositionX<=338 && PositionY>=134 && PositionY<=152 && Compass>=92 && Compass<=270&&(LoadedObjects<1
))
    {
        Duration = 1;
        CurAction =21;
    }
    else if(CSLeft_R>=226 && CSLeft_R<=246 && CSLeft_G>=226 && CSLeft_G<=246 && CSLeft_B<=20)
    {
        Duration = 1;
        CurAction =22;
    }
    else if(CSRight_R>=226 && CSRight_R<=246 && CSRight_G>=226 && CSRight_G<=246 && CSRight_B<=20)
    {
        Duration = 1;
        CurAction =23;
    }
    else if(US_Front<=10 && US_Left<=10 && PositionX<=0 && PositionY<=0)
    {
        Duration = 0;
        CurAction =24;
    }
    else if(US_Front<=10 && US_Right<=10 && PositionX<=0 && PositionY<=0)
    {
        Duration = 0;
        CurAction =25;
    }
    else if(US_Left<=10 && PositionX<=0 && PositionY<=0)
    {
        Duration = 0;
        CurAction =26;
    }
    else if(US_Right<=10 && PositionX<=0 && PositionY<=0)
    {
        Duration = 0;
        CurAction =27;
    }
    else if(US_Front<=10 && PositionX<=0 && PositionY<=0)
    {
        Duration = 0;
        CurAction =28;
    }
    ...
    else if(CSRight_R>=53 && CSRight_R<=73 && CSRight_G>=95 && CSRight_G<=115 && CSRight_B>=171 && CSRight_B<=191)
    {
        Duration = 6;
        CurAction =31;
    }
    else if(US_Front<=10 && US_Left<=10&&((CSLeft_R>=143&&CSLeft_R<=163&&CSLeft_G>=143&&CSLeft_G<=163&&CSLeft_B>=143&&CSLeft_B<=163)||(CSRight_R>=143&&CSRight_R<=163&&CSRight_G>=143&&CSRight_G<=163&&CSRight_B>=143&&CSRight_B<=163)))
    {
        Duration = 0;
        CurAction =32;
    }
    else if(US_Front<=10 && US_Right<=10&&((CSLeft_R>=143&&CSLeft_R<=163&&CSLeft_G>=143&&CSLeft_G<=163&&CSLeft_B>=143&&CSLeft_B<=163)||(CSRight_R>=143&&CSRight_R<=163&&CSRight_G>=143&&CSRight_G<=163&&CSRight_B>=143&&CSRight_B<=163)))
    {
        Duration = 0;
        CurAction =33;
    }
    else if(US_Left<=10&&((CSLeft_R>=143&&CSLeft_R<=163&&CSLeft_G>=143&&CSLeft_G<=163&&CSLeft_B>=143&&CSLeft_B<=163)||(CSRight_R>=143&&CSRight_R<=163&&CSRight_G>=143&&CSRight_G<=163&&CSRight_B>=143&&CSRight_B<=163)))
    {
        Duration = 0;
        CurAction =34;
    }
    else if(US_Right<=10&&((CSLeft_R>=143&&CSLeft_R<=163&&CSLeft_G>=143&&CSLeft_G<=163&&CSLeft_B>=143&&CSLeft_B<=163)||(CSRight_R>=143&&CSRight_R<=163&&CSRight_G>=143&&CSRight_G<=163&&CSRight_B>=143&&CSRight_B<=163)))
    {
        Duration = 0;
        CurAction =35;
    }
    else if(US_Front<=10&&((CSLeft_R>=143&&CSLeft_R<=163&&CSLeft_G>=143&&CSLeft_G<=163&&CSLeft_B>=143&&CSLeft_B<=163)||(CSRight_R>=143&&CSRight_R<=163&&CSRight_G>=143&&CSRight_G<=163&&CSRight_B>=143&&CSRight_B<=163)
))
    {
        Duration = 0;
        CurAction =36;
    }
    else if((CSLeft_R>=143&&CSLeft_R<=163&&CSLeft_G>=143&&CSLeft_G<=163&&CSLeft_B>=143&&CSLeft_B<=163)||(CSRight_R>=143&&CSRight_R<=163&&CSRight_G>=143&&CSRight_G<=163&&CSRight_B>=143&&CSRight_B<=163))
    {
        Duration = 0;
        CurAction =37;
    }
    else if(CSLeft_R>=226 && CSLeft_R<=246 && CSLeft_G<=12 && CSLeft_B>=202 && CSLeft_B<=222)
    {
        Duration = 65;
        CurAction =38;
    }
    else if(CSRight_R>=226 && CSRight_R<=246 && CSRight_G<=12 && CSRight_B>=202 && CSRight_B<=222)
    {
        Duration = 65;
        CurAction =39;
    }
    else if(CSLeft_R<=20 && CSLeft_G<=20 && CSLeft_B<=20&&(LoadedObjects<6&&LoadedBlackObjects<3
))
    {
        Duration = 55;
        CurAction =40;
    }
    else if(CSRight_R>=31 && CSRight_R<=51 && CSRight_G>=31 && CSRight_G<=51 && CSRight_B>=32 && CSRight_B<=52&&(LoadedObjects<6&&LoadedBlackObjects<3
))
    {
        Duration = 55;
        CurAction =41;
    }
    else if(CSLeft_R>=227 && CSLeft_R<=247 && CSLeft_G<=20 && CSLeft_B<=20&&(LoadedObjects<6&&LoadedRedObjects<3
))
    {
        Duration = 55;
        CurAction =42;
    }
    else if(CSRight_R>=227 && CSRight_R<=247 && CSRight_G<=20 && CSRight_B<=0&&(LoadedObjects<6&&LoadedRedObjects<3
))
    {
        Duration = 55;
        CurAction =43;
    }
    else if(CSLeft_R<=20 && CSLeft_G>=226 && CSLeft_G<=246 && CSLeft_B>=226 && CSLeft_B<=246&&(LoadedObjects<6&&LoadedCyanObjects<3
))
    {
        Duration = 55;
        CurAction =44;
    }
    else if(CSRight_R<=20 && CSRight_G>=226 && CSRight_G<=246 && CSRight_B>=226 && CSRight_B<=246&&(LoadedObjects<6&&LoadedCyanObjects<3
))
    {
        Duration = 55;
        CurAction =45;
...
if((PositionX<115 || PositionX>235) && (PositionY<70 || PositionY>209)){
isin=0;
